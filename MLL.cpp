...
int main()
{
       ...
       do
       {
              ...
              case 2:
                     ...
                     do
                     {
                           printf(" Masukan Nama Barang yang ingin dipesan: ");
                           scanf("%[^\n]", type); fflush(stdin);
                     }
              ...
              case 3:
                     ...
                     do
                     {
                           printf("Masukan Jumlah Pesanan: ", total);
